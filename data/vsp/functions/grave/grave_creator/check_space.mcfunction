...
execute as @s at @s unless block ~ ~-1 ~ #vsp:grave_blockers unless block ~ ~-1 ~ #minecraft:flower_pots unless block ~ ~-1 ~ #minecraft:banners unless block ~ ~-1 ~ #minecraft:beds unless block ~ ~-1 ~ #minecraft:anvil unless block ~ ~-1 ~ #minecraft:shulker_boxes run function vsp:grave/grave_creator/create_grave
