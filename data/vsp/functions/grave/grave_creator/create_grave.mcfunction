...
# Places grave blocks
execute at @e[tag=vsp_grave_marker,tag=!vsp_grave_marker_active,sort=nearest,limit=1,distance=..3] run setblock ~ ~-1 ~ minecraft:podzol destroy
execute at @e[tag=vsp_grave_marker,tag=!vsp_grave_marker_active,sort=nearest,limit=1,distance=..3] run setblock ~ ~ ~ minecraft:andesite_wall[west=true,east=true] destroy
