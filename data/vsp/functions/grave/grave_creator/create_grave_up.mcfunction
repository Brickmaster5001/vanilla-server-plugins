...
execute at @e[tag=vsp_grave_center,sort=nearest,limit=1] run summon armor_stand ~ ~-0.5 ~ {NoGravity:1b,Marker:1b,Invisible:1b,Tags:["vsp_grave_marker","vsp_grave_part"]}
...
execute at @e[tag=vsp_grave_marker,tag=!vsp_grave_set,sort=nearest,limit=1] at @s run summon hopper_minecart ~ ~ ~ {NoGravity:1b,Tags:["vsp_grave_storage","vsp_grave_part"]}
execute at @e[tag=vsp_grave_marker,tag=!vsp_grave_set,sort=nearest,limit=1] at @s run summon hopper_minecart ~ ~ ~ {NoGravity:1b,Tags:["vsp_grave_storage","vsp_grave_part"]}
execute at @e[tag=vsp_grave_marker,tag=!vsp_grave_set,sort=nearest,limit=1] at @s run summon hopper_minecart ~ ~ ~ {NoGravity:1b,Tags:["vsp_grave_storage","vsp_grave_part"]}
execute at @e[tag=vsp_grave_marker,tag=!vsp_grave_set,sort=nearest,limit=1] at @s run summon hopper_minecart ~ ~ ~ {NoGravity:1b,Tags:["vsp_grave_storage","vsp_grave_part"]}
execute at @e[tag=vsp_grave_marker,tag=!vsp_grave_set,sort=nearest,limit=1] at @s run summon hopper_minecart ~ ~ ~ {NoGravity:1b,Tags:["vsp_grave_storage","vsp_grave_part"]}
